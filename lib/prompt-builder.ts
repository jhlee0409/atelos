...
**⚠️ 중요: 장면 연속성 규칙**
- 3단계는 **하나의 연속된 장면**으로 자연스럽게 흘러가야 합니다
- 회상/내면 묘사 중에 갑자기 캐릭터가 등장하면 안 됩니다
- 프롤로그가 회상이라면, 촉발 사건으로 "현재로 돌아온 뒤" 캐릭터가 등장해야 합니다
- 캐릭터 등장 전에 **주인공이 현재 상황에 있음**을 명확히 해야 합니다

**1단계: 프롤로그 (100-150자)**
${storyOpening.prologue
  ? `제공된 프롤로그를 바탕으로 확장:
"${storyOpening.prologue}"
※ 회상이라면 회상임을 명확히 하고, 마지막에 현재로 돌아오는 전환 필요`
  : `주인공의 평범한 일상을 묘사:
- 어제까지의 삶이 어떠했는지
- 주인공이 어떤 사람인지
- 일상적인 환경과 분위기`}
...
${storyOpening.incitingIncident
  ? `제공된 촉발 사건을 바탕으로 확장:
"${storyOpening.incitingIncident}"
※ 이 사건이 주인공을 현재 상황에 깨어나게 하거나, 행동하게 만들어야 함`
  : `일상을 깨뜨리는 결정적 순간:
- 갑자기 발생한 변화
- 주인공의 즉각적인 반응
- "이제 돌아갈 수 없다"는 느낌`}
...
- **등장이 자연스러워야 함**:
  - 예: "문을 열고 나가니 누군가 있었다", "소리를 듣고 고개를 들자 그가 서 있었다"
  - 금지: 회상 중에 갑자기 등 뒤에서 목소리가 들림 ❌
- 주인공과의 첫 대화 또는 상호작용
...
### EXAMPLE OUTPUT (2025 Enhanced - 장면 연속성 + 1인칭 필수) ###
{
  "prologue": "차가운 금속 벽에 손을 대며 며칠 전의 평화로운 일상을 떠올렸다. 가족의 웃음소리, 따뜻한 집... 하지만 지금 창밖으로 보이는 건 끝없이 펼쳐진 설원뿐이었다.\\n\\n*7일. 가족을 다시 볼 수 있는 시간은 그게 전부였다.* 눈을 감았다 떴다.",
  "incitingIncident": "삐- 삐- 삐-.\\n\\n**동면 장치의 경고음이 정적을 갈랐다.** 나는 벌떡 자리에서 일어났다. 잔여 전력 위험 수준. 심장이 철렁 내려앉았다. 서둘러 제어판을 확인하려 문 쪽으로 향했다.",
  "firstEncounter": "문을 열자마자, 낯선 남자와 마주쳤다.\\n\\n**\\"...이 근처에서 온 건 아니군.\\"**\\n\\n그의 눈빛은 경계심으로 가득했다. 이 황량한 곳에서 다른 생존자를 만나다니. *적인가, 아군인가.* 나는 그의 태도를 살피며 한 발짝 물러섰다.",
  "dilemma": {
    "prompt": "처음 보는 남자가 길을 막고 서 있다. 동면 장치의 경고음이 계속 울리는 가운데, 어떻게 해야 할까?",
    "choice_a": "상황을 솔직하게 설명하고 도움을 요청한다",
    "choice_b": "경계를 유지하며 그의 정체부터 파악한다",
    "choice_c": "일단 그를 피해 다른 경로를 찾는다"
  }
}

**위 예시의 장면 연속성 포인트:**
- 프롤로그: 회상 후 "눈을 감았다 떴다"로 현재로 복귀
- 촉발 사건: 경고음에 "벌떡 일어나" 행동 개시, "문 쪽으로 향함"
- 첫 만남: "문을 열자마자" 자연스러운 만남 → 회상 중 갑자기 등장 ❌
